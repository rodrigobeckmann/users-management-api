  ...
  <div class="flex flex-col size-full lg:flex-row">
    <div class="order-2 flex w-full justify-center lg:justify-end lg:order-1">
      <ul class="flex flex-col gap-4 items-center lg:m-10 w-80">
        <li
          class="flex bg-gray-400/50 w-full rounded-md p-2 font-mono text-sm tracking-normal shadow justify-between border"
          ...
          <div class="flex flex-col gap-2">
            <font-awesome-icon class="hover:text-yellow-600 cursor-pointer m-[2px]" icon="fa-solid fa-pen" />
    ...
    <div class="flex justify-center order-1 w-full lg:order-2 lg:justify-start">
      <aside class="flex bg-gray-400/50 w-96 m-10 h-96 rounded-md shadow justify-between border">
      </aside>
    </div>
  </div>
</template>
